...
const AppointmentCard: React.FC<AppointmentProps> = ({ appointment, onCancel }) => {
            ...
            case "cancelled":
                return (
                    <>
                        ...
                        <button onClick={handleBookAgain} className="flex-1 bg-[#145DB8] text-white rounded-[10px] py-2 text-[14px] font-normal">Support</button>
                    </>
                );
